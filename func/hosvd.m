...
%      'economy'    - To avoid memory crash.                 Default: true. 
%
...
params.addParameter('economy', true);
...
economy    = params.Results.economy   ;
...
if economy
    for k = dimorder
        ...
        % Select top-r eigenvectors (columns of U)
        U{k} = Us(:,1:r(k));
